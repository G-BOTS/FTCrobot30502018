...
/**
 * Created by robot3050 on 2/21/2018.
 */
...
import org.firstinspires.ftc.robotcore.external.navigation.VuforiaTrackables;
    ...
    @Autonomous(name="3050: playwithencoders", group="3050")
//@Disabled
    public class playwithencoders extends LinearOpMode {
         ...
         */
            ...
            telemetry.update();
            sleep(250);
            while ((robot.Elevator.getCurrentPosition() < 200) && (robot.Elevator.getCurrentPosition() >= 0))
            {
